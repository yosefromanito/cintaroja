...
El Usuario debe leer, entender y aceptar todas las condiciones establecidas en los Términos y Condiciones Generales y en el Aviso de Privacidad así como en los demás documentos incorporados a los mismos por referencia, previo a su inscripción como Usuario de MercadoLibre.

La utilización del Sitio y/o los Servicios por parte del Usuario, implica su consentimiento expreso, libre, informado, específico e inequívoco a los Avisos de Privacidad de MercadoLibre, S. de R.L. de C.V., Deremate.com de México, S. de R.L. de  C.V. y Mercado Lending, S.A de C.V  así como su consentimiento expreso de todas las políticas establecidas en las Condiciones Generales y sus Anexos, y demás políticas y principios incorporados a las mismas por referencia.
...
Las personas que utilicen los Servicios de manera habitual para vender productos, o para comprar productos con fines de reventa, aceptan expresamente en considerarse comerciantes en los términos del artículo 3, fracción I, del Código de Comercio.

02 - Inscripción
Es obligatorio completar el formulario de inscripción en todos sus campos con datos válidos para poder utilizar los servicios que brinda MercadoLibre. El futuro Usuario deberá completarlo con su información personal de manera exacta, precisa y verdadera (en adelante, los "Datos Personales") y asume el compromiso de actualizar y/o rectificar los Datos Personales conforme resulte necesario. El Usuario autoriza a Mercado Libre a que utilice diversos medios para identificar sus datos personales, asumiendo el Usuario la obligación de revisarlos, rectificarlos y mantenerlos actualizados. Mercado Libre NO se responsabiliza por la certeza de los Datos Personales de sus Usuarios. Los Usuarios garantizan y responden, en cualquier caso, de la veracidad, exactitud, vigencia y autenticidad de sus Datos Personales.
...
Como parte del proceso para completar el formulario de inscripción, para poder utilizar su cuenta en el Sitio, así como realizar cualquier función en el Sitio o hacer uso de los Servicios, el Usuario autoriza como medios de autenticación aquellos medios electrónicos, tales coimo, número de identificación personal, huella digital, firma electrónica, o cualquier otro que determine MercadoLibre. 
...
Al registrarse en MercadoLibre, el usuario también tendrá una cuenta en los siguiente sitio web asociado a MercadoLibre, a saber: www.metroscubicos.com (en adelante, “Metros Cúbicos” o “M3”). Su usuario y clave de Mercado Libre le servirá para entrar a ese sitio. Las cuentas estarán combinadas, por lo tanto podrá administrar las publicaciones de inmuebles desde Metros Cúbicos. Lo que haga allí se reflejará en MercadoLibre, y viceversa.

Asimismo, todo lo que suceda con el estado y la facturación de su cuenta en MercadoLibre, se reflejará en la de los mencionados sitios web, y viceversa.

Ante ello, la registración como usuario de Mercado Libre implicará también la aceptación y el conocimiento de los Términos y Condiciones Generales de Uso del sitio de Metros Cúbicos.

 

A su exclusiva discreción, Mercado Libre podrá requerir una inscripción adicional a los Usuarios que operen como agencias o inmobiliarias, como requisito para que dichos Usuarios accedan a paquetes especiales de publicaciones. En estos casos, una vez efectuada la inscripción adicional, las ofertas de venta de inmuebles que realicen las agencias o inmobiliarias, respectivamente, se publicarán en Metros Cúbicos y también en MercadoLibre,  a través de alguno de dichos paquetes o bajo las modalidades que Mercado Libre habilite para este tipo de Usuarios.

La Cuenta es personal, única e intransferible, y está prohibido que un mismo Usuario inscriba o posea más de una Cuenta. En caso que Mercado Libre detecte distintas Cuentas que contengan datos coincidentes o relacionados, podrá cancelar, suspender o inhabilitarlas.

El Usuario será responsable por todas las operaciones efectuadas en su Cuenta, pues el acceso a la misma está restringido al ingreso y uso de su Clave de Seguridad, de conocimiento exclusivo del Usuario. El Usuario se compromete a notificar a Mercado Libre en forma inmediata y por medio idóneo y fehaciente, cualquier uso no autorizado de su Cuenta, así como el ingreso por terceros no autorizados a la misma. Se aclara que está prohibida la venta, cesión o transferencia de la Cuenta (incluyendo la reputación y opiniones) bajo ningún título.

MercadoLibre se reserva el derecho de rechazar cualquier solicitud de inscripción o de cancelar una inscripción previamente aceptada, sin que esté obligado a comunicar o exponer las razones de su decisión y sin que ello genere algún derecho a indemnización o resarcimiento.
...
El uso del sitio y/o sus servicios implica la aceptación de estos Términos y Condiciones generales de uso de MercadoLibre.
...
Los inmuebles que se publiquen en Mercado Libre también aparecerán en el sitio de Metros Cúbicos y/o cualquier otra página de internet o red social con la que MercadoLibre tenga algún acuerdo comercial para dar mayor difusión a las publicaciones. Para efectos de lo anterior, el usuario acepta que MercadoLibre podrá compartir sus datos de contacto como nombre, correo electrónico y teléfono.

4.5 Artículos Prohibidos.
Sólo podrán ser ingresados en las listas de bienes y/o servicios ofrecidos, aquellos cuya venta no se encuentre tácita o expresamente prohibida en los Términos y Condiciones Generales y demás políticas de Mercado Libre o por la ley vigente. Para obtener mayor información sobre artículos o servicios prohibidos, se pueden consultar las Políticas de Artículos Prohibidos de MercadoLibre.

4.6 Brand Protection Program.
...
El vendedor acepta que el comprador puede revocar la compra dentro de un plazo de 10 días desde que recibe el producto. Asimismo, el vendedor acepta que los compradores podrán pedir el cambio o devolución del producto en los términos de los programas de Compra Protegida, Mercado Puntos y demás Anexos, hasta 30 días después de la recepción del producto.

En cualquiera de los mencionados casos, el vendedor deberá aceptar el cambio o devolución del producto vendido y deberá hacerse cargo de los gastos que esto conlleve, incluyendo los costos de envío que fueran necesarios. Mercado Libre podrá debitar estos costos de la cuenta de Mercado Pago del vendedor.
...
10 - Responsabilidad
MercadoLibre sólo pone a disposición de los Usuarios un espacio virtual que les permite ponerse en comunicación mediante Internet para encontrar una forma de vender o comprar bienes y/o servicios. Mercado Libre no es el propietario de los artículos ofrecidos, no tiene posesión de ellos ni los ofrece en venta. Mercado Libre no interviene en el perfeccionamiento de las operaciones realizadas entre los Usuarios ni en las condiciones por ellos estipuladas para las mismas, por ello no será responsable respecto de la existencia, calidad, cantidad, estado, integridad o legitimidad de los bienes ofrecidos, adquiridos o enajenados por los Usuarios, así como de la capacidad para contratar de los Usuarios o de la veracidad de los Datos Personales por ellos ingresados. Cada Usuario conoce y acepta ser el exclusivo responsable por los artículos que publica para su venta y por las ofertas y/o compras que realiza.

Debido a que Mercado Libre no tiene ninguna participación durante todo el tiempo en que el artículo se publica para la venta, ni en la posterior negociación y perfeccionamiento del contrato definitivo entre las partes, no será responsable por el efectivo cumplimiento de las obligaciones asumidas por los Usuarios en el perfeccionamiento de la operación. El Usuario conoce y acepta que al realizar operaciones con otros Usuarios o terceros lo hace bajo su propio riesgo. En ningún caso Mercado Libre será responsable por lucro cesante, o por cualquier otro daño y/o perjuicio que haya podido sufrir el Usuario, debido a las operaciones realizadas o no realizadas por artículos publicados a través de MercadoLibre.

MercadoLibre recomienda actuar con prudencia y sentido común al momento de realizar operaciones con otros Usuarios. El Usuario debe tener presentes, además, los riesgos de contratar con menores o con personas que se valgan de una identidad falsa. Mercado Libre NO será responsable por la realización de ofertas y/o operaciones con otros Usuarios basadas en la confianza depositada en el sistema o los Servicios brindados por MercadoLibre.

En caso que uno o más Usuarios o algún tercero inicien cualquier tipo de reclamo o acciones legales contra otro u otros Usuarios, todos y cada uno de los Usuarios involucrados en dichos reclamos o acciones eximen de toda responsabilidad a Mercado Libre y a sus directores, gerentes, empleados, agentes, operarios, representantes y apoderados. Los Usuarios tienen un plazo de 60 días desde la compra para iniciar un reclamo contra otro u otros Usuarios. Una vez vencido este plazo, no podrán iniciar un reclamo desde el sitio de MercadoLibre.
...
MercadoLibre no se responsabiliza por cualquier daño, perjuicio o pérdida al Usuario causados por fallas en el sistema, en el servidor o en Internet. Mercado Libre tampoco será responsable por cualquier virus que pudiera infectar el equipo del Usuario como consecuencia del acceso, uso o examen de su sitio web o a raíz de cualquier transferencia de datos, archivos, imágenes, textos, o audio contenidos en el mismo. Los Usuarios NO podrán imputarle responsabilidad alguna ni exigir pago por lucro cesante, en virtud de perjuicios resultantes de dificultades técnicas o fallas en los sistemas o en Internet. Mercado Libre no garantiza el acceso y uso continuado o ininterrumpido de su sitio. El sistema puede eventualmente no estar disponible debido a dificultades técnicas o fallas de Internet, o por cualquier otra circunstancia ajena a MercadoLibre; en tales casos se procurará restablecerlo con la mayor celeridad posible sin que por ello pueda imputársele algún tipo de responsabilidad. Mercado Libre no será responsable por ningún error u omisión contenidos en su sitio web.

13 - Tarifas. Facturación
La inscripción en Mercado Libre es gratuita.

El usuario vendedor solo deberá pagar a Mercado Libre un costo por la venta cuando la operación se concrete o si no la cancela antes de los 21 días después de recibir la oferta. Para el caso correspondiente a las categorías Vehículos, motos y otros, Servicios e Inmuebles, el Usuario deberá pagar únicamente un costo por publicar.

MercadoLibre se reserva el derecho de tomar las medidas judiciales y extrajudiciales que estime pertinentes para obtener el pago del monto debido.
...
Debido a que la verificación de la identidad de los Usuarios en Internet es difícil, Mercado Libre no puede confirmar ni confirma la identidad pretendida de cada Usuario. Por ello el Usuario vendedor cuenta con un sistema de reputación que es actualizado periódicamente en base a datos vinculados con su actividad en el sitio. Este usuario, además, podrá recibir comentarios u opiniones por parte del Usuario comprador. Dichos comentarios serán incluidos en el perfil de Usuario, bajo exclusiva responsabilidad de los Usuarios que los emitan.

Mercado Libre no asume obligación de verificar la veracidad o exactitud de los comentarios.

Mercado Libre NO se responsabiliza por los dichos allí vertidos, por la confianza depositada en la reputación los Usuarios, o en cualquier comentario expresado sobre dicho Usuario dentro del sitio, o a través de cualquier otro medio, o por las ofertas de compras o ventas que los Usuarios realicen teniendo en cuenta dicha reputación o comentarios. Mercado Libre se reserva el derecho de editar y/o eliminar aquellos comentarios que sean considerados inadecuados u ofensivos. Mercado Libre mantiene el derecho de excluir a aquellos Usuarios que sean objeto de comentarios negativos provenientes de fuentes distintas. Para obtener mayor información se pueden consultar nuestro Sistema de Reputación de MercadoLibre.

15 - Propiedad intelectual - Licencias - Enlaces
...
Términos y condiciones de contratación Mercado Libre Publicidad

Términos y condiciones de Tarjeta de Regalo MercadoLibre

Términos y condiciones de MercadoPago

Términos y condiciones de Mercado Envíos

Términos y condiciones de Mercado Envíos Full
Términos y condiciones de uso de MercadoShops

Términos y condiciones de Mercado Puntos

Términos y condiciones de Mercado Libre Solidario
Términos y condiciones generales de Metros Cúbicos

Términos y condiciones del servicio de suscripciones
...
Sistema de opiniones de servicios

Sistema de opiniones de automóviles
...
Productos vendidos por Mercado Libre
...
19 - Domicilio
Se fija como domicilio de DeRemate.com de México, S. de R.L. de C.V. y MercadoLibre, S. de R.L. de C.V. la calle Insurgentes Sur 1602 Piso 9, Colonia Crédito Constructor, Alcaldía Benito Juárez, C.P. 03940, Ciudad de México, México.

Si tienes alguna duda sobre los Términos y Condiciones Generales o demás políticas y principios que rigen Mercado Libre consulta nuestra página de Ayuda.</p>
       <Footer/>
        </div>
    )
}

export default Avisodepriv
